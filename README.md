...
Know an exercise or video that isn't listed below? Feel free to create a new [pull request](https://github.com/jaymeh13/keyboard-gym/pulls), or open an [issue](https://github.com/jaymeh13/keyboard-gym/issues/new).
